...
type TelemetryServiceClient interface {
	SendTelemetry(ctx context.Context, in *TelemetryData, opts ...grpc.CallOption) (*TelemetryResponse, error)
}
...
func (c *telemetryServiceClient) SendTelemetry(ctx context.Context, in *TelemetryData, opts ...grpc.CallOption) (*TelemetryResponse, error) {
...
type TelemetryServiceServer interface {
	SendTelemetry(context.Context, *TelemetryData) (*TelemetryResponse, error)
...
func (UnimplementedTelemetryServiceServer) SendTelemetry(context.Context, *TelemetryData) (*TelemetryResponse, error) {
...
func _TelemetryService_SendTelemetry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TelemetryServiceServer).SendTelemetry(ctx, req.(*TelemetryData))
	}
